...
<head>
    ...
    <title>Gestió d'Arxius - Dropbox</title>
...
<div class="user-info">
    Conectat com <strong><?php echo htmlspecialchars($_SESSION['username']); ?></strong>
</div>

<div class="upload-container">
    <h1>Gestió d'Arxius</h1>
    <p>Arrossega i deixa anar arxius aquí per pujar-los a Dropbox.</p>

    <form action="upload_to_dropbox.php" method="post" enctype="multipart/form-data" id="upload-form">
        ...
        <button type="submit" class="upload-button">Pujar a Dropbox</button>
